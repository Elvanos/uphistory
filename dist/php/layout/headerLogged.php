<header class='M_header js-header'>
    ...
    <div class="E_hamburgerMenu -header js-headerMenu">
        ...
        <div class="E_dropdown">
            ...
            <a class="E_dropdown__pick -main" title="Notifikace" href="/uh/php/layout/globals/flGlobalUploadGeneral.php"
               data-featherlight="ajax">
                <div class="E_dropdown__pick__specialBackground -upload"></div>
                <div class="mobileDescription">Upload</div>

            </a>


            <div class="E_dropdown__menu">
                <div class="E_dropdown__menu__contentWrapper">
                    <div class="E_dropdown__menu__contentWrapper__inner">
                        <div class="E_dropdown__menu__contentWrapper__inner__single">
        ...
        <div class="E_dropdown -headerPrivateMessages js-popup">


            <div class="E_dropdown__pick -main js-popupTrigger" title="Notifikace">
                <div class="E_dropdown__pick__specialBackground -notifications">126</div>
                <div class="mobileDescription">Notifikace</div>
            </div>
